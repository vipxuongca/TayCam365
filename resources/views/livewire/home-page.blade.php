  ...
  <div class="w-full h-screen bg-gradient-to-r from-blue-200 to-cyan-200 py-10 px-4 sm:px-6 lg:px-8 mx-auto">
    <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
        <div>
          <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">Mua sắm thỏa thích tại
            <br>
            <span class="text-blue-600">TayCam365</span>
          </h1>
          <p class="mt-3 text-lg text-gray-800 dark:text-gray-400">Mua sắm thỏa thích với rất nhiều loại mẫu sản phẩm khác nhau</p>
        ...
        <div class="relative ms-4">
          <img class="w-full rounded-md" src="https://cdn.mos.cms.futurecdn.net/cR9Sn7JStxm8HoDNW3J4Xn-970-80.jpg.webp" alt="Controller">
